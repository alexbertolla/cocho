...
if __name__ == '__main__':
    try:
        ...
        while th_barriga.is_alive():# th_face.is_alive() or th_dorso.is_alive() or th_barriga.is_alive():
            frame_captured = np.hstack((cam_barriga.frame_show)) #np.hstack((cam_face.frame_show, cam_dorso.frame_show, cam_barriga.frame_show))
